...
for running simulation with the DynaMICE model. An example run is conducted for 
Pakistan with MCV1, MCV2, and SIA vaccination, with all the updated assumptions 
for the key determinants ('full-update' scenario).
